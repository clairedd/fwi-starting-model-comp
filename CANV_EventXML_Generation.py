...
gcmtfile = '/Users/claired/Desktop/Salvus/gcmt_datetime_catalog.csv'
...
# ### Grab events from Salvus Project to remove events that did not meet quality control

# +
from salvus import namespace as sn

p = sn.Project(path="/Users/claired/Desktop/CANV_CSEM/")
...
catalog.write('CANV_catalog.xml',format="QUAKEML")
